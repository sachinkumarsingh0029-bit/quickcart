...
const ProductLayout: React.FC<UserLayoutProps> = ({ children }) => {
  ...
  const handleTab = () => {
    ...
    } else if (window.location.pathname.includes("/updateproduct")) {
  ...
  return (
    <div className="mt-10 p-4">
      <div className="flex overflow-x-auto whitespace-nowrap w-full">
        <button
          className={activeTab === "Product" ? activeClass : inactiveClass}
        ...
        {activeTab === "Update Product" && (
          <button
            className={
              activeTab === "Update Product" ? activeClass : inactiveClass
            }
          >
            Update Product
          </button>
