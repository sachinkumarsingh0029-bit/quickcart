...
const WithdrawalRequestLayout: React.FC<UserLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="mt-10 p-4">
      <div className="flex overflow-x-auto whitespace-nowrap w-full">
        <button
          className={activeTab === "Payroll" ? activeClass : inactiveClass}
...
export default WithdrawalRequestLayout;
