...
const UserLayout: React.FC<UserLayoutProps> = ({ children }) => {
  ...
  const handleTab = () => {
    if (window.location.pathname === "/user") {
      setActiveTab("Users");
    } else if (window.location.pathname === "/newuser") {
      setActiveTab("New User");
    } else if (window.location.pathname.includes("/updateuser")) {
  ...
  return (
    <div className="mt-10 p-4">
      <div className="flex overflow-x-auto whitespace-nowrap w-full">
        ...
        <button
          className={activeTab === "New User" ? activeClass : inactiveClass}
        ...
        {activeTab === "Update User" && (
          <button
            className={
              activeTab === "Update User" ? activeClass : inactiveClass
            }
          >
            Update User
          </button>
